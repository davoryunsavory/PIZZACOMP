...
public class display {
    ...
    public static void toppings(Console c, Scanner sc) {
        ...
        c.writer().print("13: Go back to menu\t14: Finish order\n");
        c.flush();

        // validation
        int option = validation.val_int(sc, 14, "Not an option", "Select between 1 - 14: ");
    ...
    /*
     * public static int selectquantity(Console c, Scanner sc) { int amount = 0;
     * String[] validchar = { "+", "-" }; c.writer().print(ESC + "[2J");
     * c.writer().print(ESC + "[1;1H"); c.writer().print("Please select amount\n");
     * c.writer().print("To add press '+', to subtract press '-'\n");
     * c.writer().print("Item selected: Ham Chunks\n");
     * c.writer().print("Quantity:  \n"); c.flush(); String output = ""; while
     * (!output.equals("e")) { output = validation.val_plusminus(sc, validchar,
     * "Your a dumb ass david", ""); if (output.equals("+")) { amount += 1;
     * c.writer().print(ESC + "[4;10H"); c.writer().print(amount);
     * c.writer().print(ESC + "[6;1H"); c.flush(); } else { amount -= 1;
     * c.writer().print(ESC + "[4;10H"); c.writer().print(amount);
     * c.writer().print(ESC + "[6;1H"); c.flush(); } }
     * 
     * toppings(c, sc); return amount; }
     */
